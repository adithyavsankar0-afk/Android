...
interface ImportBookmarksPixelSender {
    ...
    fun onImportFailed(
        reason: com.duckduckgo.autofill.impl.importing.takeout.webflow.UserCannotImportReason,
        source: AutofillImportLaunchSource,
    )
...
class ImportBookmarksPixelSenderImpl @Inject constructor(
    private val pixel: Pixel,
    private val engagementBucketing: AutofillEngagementBucketing,
) : ImportBookmarksPixelSender {
    ...
    override fun onImportFailed(
        ...
        val pixelName =
            when (reason) {
                UserCannotImportReason.DownloadError -> "TODO()"
                UserCannotImportReason.ErrorParsingBookmarks -> "TODO()" // AUTOFILL_IMPORT_GOOGLE_PASSWORDS_RESULT_FAILURE_ERROR_PARSING
            }
        val params = mapOf(SOURCE_KEY to source.value)
