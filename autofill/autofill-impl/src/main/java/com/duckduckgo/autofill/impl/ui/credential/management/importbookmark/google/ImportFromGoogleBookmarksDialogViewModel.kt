...
class ImportFromGoogleBookmarksDialogViewModel @Inject constructor(
    private val credentialImporter: CredentialImporter,
    private val dispatchers: DispatcherProvider,
    private val pixelSender: ImportBookmarksPixelSender,
    ...
    fun onImportFlowCancelledByUser(
        ...
        pixelSender.onUserCancelledImportWebFlow(stage, importSource)
    }

    private fun fireImportSuccessPixel(
        savedCredentials: Int,
        numberSkipped: Int,
        importSource: AutofillImportLaunchSource,
    ) {
        pixelSender.onImportSuccessful(
    ...
    private fun fireImportFailedPixel(
        reason: UserCannotImportReason,
        importSource: AutofillImportLaunchSource,
    ) {
        pixelSender.onImportFailed(reason, importSource)
    }

    fun onPreflowDialogDismissed() {
    ...
    data class ViewState(
        val viewMode: ViewMode = ViewMode.DeterminingFirstView,
    )
